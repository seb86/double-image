...
- If you're a developer yourself, follow or contribute to the [Double Image plugin on GitHub](https://github.com/seb86/double-image)
...
2. Two images set
3. Both images with overlay color and overlay text
